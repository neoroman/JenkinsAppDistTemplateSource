    ...
    if (isset($_GET['rename'])) {
      foreach (glob("$osDir/*/*$file_name*") as $filename) {
        ...
        if (endsWith($filename, "html")) {
          // echo "<H2>Delete HTML snippet temporarily.... [ DONE ]</H2>";
          rename($filename, "$filename.deleted");
          break;
        }
      }
