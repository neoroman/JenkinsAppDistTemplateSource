...
<body>
  <?php
   ...
   ?>
<!-- wrap -->
<div class="wrap sub_type2"> <!-- (내부)sub_type1, (외부)sub_type2 -->
  <div class="header">
    <div class="inner">
      <h1 class="logo"><a href="../dist_client.php"><?php echo L::client_title ." ". L::app_name ?></a></h1>
      <a href="../dist_client.php" class="page_prev"><span class="hide"><?php echo L::title_alt_previous_page ?></span></a>
  ...
  <div class="tab_version">
    ...
    <?php if ($usingPreviousVersion) {
      echo "<a href=\"". $outUrl ."/". $topPathPreviousVersion ."/ios/index.php\"><span>". L::title_tab_previous_version ."</span></a>";
    }?>
  </div>

  <?php
    list($html_list, $pagenation, $currPage) = getPaginationSnippets("ios", false);
  ?>
  ...
  <div class="container">
    ...
    <div class="tab_os">
      <?php if ($usingAndroid) { ?>
      <a href="../android/index.php"><span>Android</span></a>
      <?php } ?>
      <?php if ($usingAndroid && $usingiOS) { ?>
      <span class="bar">|</span>
      <?php } ?>
      <?php if ($usingiOS) { ?>
      <a href="#" class="on"><span>iOS</span></a>
      <?php } ?>
    </div>

    <div class="cont_area">
      <div class="top_area">
       <h2 class="tit_box"><?php echo L::title_h2_client; ?>&nbsp;&nbsp;<?php 
        ...
        <p class="txt"><?php echo L::description_notice14_apple_ios_enterprise; ?></p>
      </div>
      ...
      <div class="item_area">
        ...
        if (isset($_POST['search']) && strlen($pattern) > 0 && $pattern != "Select") {
          echo getHtmlSnippets("ios", false, true, $pattern, $html_list);
        } else {
          echo getHtmlSnippets("ios", false, false, $pattern, $html_list);
        }
        ?>
        <!-- //item -->
      </div>
