...
<div class="wrap sub_type1"> <!-- (내부)sub_type1, (외부)sub_type2 -->
  ...
  <div class="tab_version">
    ...
    <?php if ($usingPreviousVersion) {
      echo "<a href=\"". $outUrl ."/". $topPathPreviousVersion ."/ios/dist_ios.php\"><span>". L::title_tab_previous_version ."</span></a>";
    }?>
  </div>

  <?php
    list($html_list, $pagenation, $currPage) = getPaginationSnippets("ios", true);
  ?>
  ...
  <div class="container">
    ...
    <div class="tab_os">
      <?php if ($usingAndroid) { ?>
      <a href="../android/dist_android.php"><span>Android</span></a>
      <?php } ?>
    ...
    <div class="cont_area">
      ...
      <div class="item_area">
        ...
        if (isset($_POST['search']) && strlen($pattern) > 0 && $pattern != "Select") {
          echo getHtmlSnippets("ios", true, true, $pattern, $html_list);
        } else {
          echo getHtmlSnippets("ios", true, false, $pattern, $html_list);
        }
        ?>
        <!-- //item -->
      </div>
...
<script src="../js/appDistCommon4client.js?v2"></script>
</body>
</html>
